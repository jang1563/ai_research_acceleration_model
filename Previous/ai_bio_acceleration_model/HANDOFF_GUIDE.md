...
You are building a quantitative model for a bioRxiv paper on AI-accelerated biological science. The model analyzes bottlenecks in the scientific discovery pipeline and forecasts progress under different AI growth scenarios.
