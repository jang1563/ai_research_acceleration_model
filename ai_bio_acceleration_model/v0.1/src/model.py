    ...
    def _default_stages(self) -> List[Stage]:
        ...
        return [
            ...
            Stage(
                ...
                M_max=3.0,             # Adaptive trials, AI patient selection (was 2.5)
                p_success=0.15,        # Improved with AI biomarkers (was 0.12)
                k_saturation=0.4       # Faster adoption with proven benefits (was 0.3)
            ),
            Stage(
                index=7,
    ...
    def _default_scenarios(self) -> List[Scenario]:
        ...
        return [
            Scenario(
                ...
                M_max_overrides={6: 2.5}  # Conservative clinical trial acceleration
            ),
            Scenario(
                name="Baseline",
                g_ai=0.50,
            ...
            Scenario(
                ...
                M_max_overrides={6: 4.0}  # Regulatory reform enables faster trials
            ),
        ]
