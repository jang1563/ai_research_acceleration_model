"""
AI-Accelerated Biological Discovery Model - v0.3

A quantitative pipeline model for analyzing bottlenecks in AI-accelerated
biological research and drug development.

Version: 0.3 (Sensitivity Analysis)
Date: January 2026
License: MIT

Key Changes from v0.2:
- Sensitivity analysis module added
- Parameter sweep functionality
- Tornado diagrams for policy prioritization
