...
This script runs the complete v0.4.1 model pipeline:
...
6. Monte Carlo uncertainty quantification (with p_success_max uncertainty)
7. Version comparison visualization (v0.3 → v0.4.1)

Key Changes in v0.4.1:
- AI-AI feedback loop: g(t) = g_0 * (1 + α*log(A(t))) [Expert Issue A1]
- p_success_max uncertainty in Monte Carlo [Expert Issue B3]
- Configurable feedback strength (alpha=0.1 default)

Key Changes in v0.4:
- Time-varying p_success [Expert Issue B4]
- Stage-specific AI growth rates
...
Outputs:
    ...
    - outputs/parameters.json: Model parameters (v0.4.1)
    - outputs/fig_version_comparison.png: v0.3 → v0.4.1 comparison
    - outputs/monte_carlo_*.csv: Monte Carlo with p_max uncertainty

Version: 0.4.1

References:
- Bostrom (2014) Superintelligence: https://www.amazon.com/dp/0198739834
- Grace et al. (2018) AI Forecasting: https://arxiv.org/abs/1705.08807
- Topol (2019) High-performance medicine: https://doi.org/10.1038/s41591-018-0300-7
- Harrer et al. (2019) AI for trials: https://doi.org/10.1016/j.tips.2019.05.005
- Saltelli et al. (2008) Sensitivity Analysis: https://doi.org/10.1002/9780470725184
"""
...
def main(run_sensitivity: bool = True, run_monte_carlo: bool = True, mc_samples: int = 1000):
    ...
    print("Version: 0.4.1 (AI-AI Feedback + Dynamic p_success)")
