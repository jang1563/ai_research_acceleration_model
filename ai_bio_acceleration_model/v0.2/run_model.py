...
This script runs the complete v0.2 model pipeline:
...
- 10-stage pipeline (was 8 in v0.1)
- More granular bottleneck analysis
...
def main():
    ...
    print("Version: 0.2 (Split Clinical Trials)")
